        ...
        <View style={Estilos.conteudoHeader}>
            <View style={Estilos.conteudoCorpo}>
                ...
                <TextInput placeholder="Digite o nome da Conta"
                    value={inputNome} onChangeText={(text) => setInputNome(text)}
                    style={Estilos.inputCad} />

                <Text>Tipo da Conta:</Text>
                <TextInput placeholder="Digite o tipo da Conta"
                    value={inputTipo} onChangeText={(text) => setInputTipo(text)}
                    style={Estilos.inputCad} />

                <Text>Saldo:</Text>
                <TextInput placeholder="Digite o saldo"
                    value={inputSaldo} onChangeText={(text) => setInputSaldo(text)}
                    style={Estilos.inputCad} />
